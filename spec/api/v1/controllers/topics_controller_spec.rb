...
RSpec.describe Api::V1::TopicsController, type: :controller do
  ...
  # Unauthenticated users can fetch a topic or all topics
  ...
  # Unauthorized users can fetch topics or all topics
  context "unauthorized user" do
    ...
    it "PUT update reutrns http forbidden" do
      put :update, id: my_topic.id, topic: { name: "Topic Name", description: "Topic Descriptino" }
